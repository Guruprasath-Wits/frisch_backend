...
Category.edit = (id, updatedCategory, result) => {
    const query = "UPDATE category SET category_name = ?,category_type = ?, category_img = ?, delivery_fee_weekday = ?, delivery_fee_weekend = ?, holiday_fee = ?, min_delivery_charge = ? WHERE id = ?";
